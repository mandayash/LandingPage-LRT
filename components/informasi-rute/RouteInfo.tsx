  ...
  return (
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <span className="font-bold break-words">Arah Bandara (12 Pemberhentian)</span>
        </div>

          {/* Station list with timeline - Menggunakan relative positioning untuk timeline */}
          <div className="relative">
            {/* Vertical line that runs through all stations */}
